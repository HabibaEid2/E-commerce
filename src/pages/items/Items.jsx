...
export default function Items() {
    ...
    let sub_cats = [
        <div className="sub-cat">
            <input type="radio" value="all" id="all" name="sub cat" onClick={() => chooseRadio(address , "all")}/>
    ...
    for (let i of data.productData) {
        ...
        mainCats.push(
            <Link to = {i.cat_name} className="cat-item" onClick={() => dispatch(productsA({ catName : i.cat_name, subCat : "all"}))}>
